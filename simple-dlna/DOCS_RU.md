...
[English version](https://github.com/alekslegkih/ha-addons/blob/main/simple-dlna/DOCS.md)
...
Аддон содержит встроенный Аайловый браузер для управления медиатекой, который позволяет:.
