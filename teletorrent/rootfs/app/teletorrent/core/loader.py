...
def load_lang():
    ...
    if not os.path.exists(LANG_FILE):
        ...
        log.info("Created default message.lang")
    ...
    try:
        ...
        log.info("Language validated successfully")
        return data
