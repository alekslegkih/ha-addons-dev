...
def load_lang():
    ...
    if not os.path.exists(LANG_FILE):
        ...
        log.log("Created default message.lang")
    ...
    try:
        ...
        log.green("Language validated successfully")
        return data
